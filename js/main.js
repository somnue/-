	...
	var loadCallback = function(loader,resources){
		...
		bg10.visible = bg.visible = bgt.visible = bg1.visible = bg2.visible = bg3.visible = bg4.visible = bg5.visible = bg6.visible = bg7.visible = bg8.visible = bg9.visible = false;
		...
		var maxx = bg10.height + app.loadingBg.height + bg.height + bg1.height + bg2.height + bg3.height + bg4.height + bg5.height + bg6.height + bg7.height + bg8.height + bg9.height;

		slide.init({el:[app.loadingBg,bg,bg1,bg2,bg3,bg4,bg5,bg6,bg7,bg8,bg9,bg10],prop:'y',minx:0,maxx:maxx,rate:15,multiple:.8});

		slide.loading = app.loadingBg;

		slide.dataEls.push({e:app.loading_text,a:0,b:app.loadingBg.height,
		...
		slide.dataEls.push({e:city,a:0,b:h*3,
			rCallback:function(r){
		...
		slide.dataEls.push({e:m0,a:h*.8,b:h*2.5,
			rCallback:function(r){	
		...
		slide.dataEls.push({e:text1,a:h*1.5,b:h*2.7,
			rCallback:function(r){
		...
		slide.dataEls.push({e:text2,a:h*3,b:h*3.9,
			rCallback:function(r){
		...
		slide.dataEls.push({e:text3,a:h*3,b:h*3.8,
			rCallback:function(r){
		...
		slide.dataEls.push({e:man1,a:h*3.3,b:h*3.6,
			rCallback:function(r){
		...
		slide.dataEls.push({e:man2,a:h*3,b:h*5,
			rCallback:function(r){
		...
		slide.dataEls.push({e:text4,a:h*3.4,b:h*4.5,
			rCallback:function(r){
		...
		slide.dataEls.push({e:man3,a:h*4,b:h*4.7,
			rCallback:function(r){
		...
		slide.dataEls.push({e:man4,a:h*4,b:h*4.7,
			rCallback:function(r){
		...
		slide.dataEls.push({e:man6,a:h*4.5,b:h*4.8,
			rCallback:function(r){
		...
		slide.dataEls.push({e:text5,a:h*4.3,b:h*5.1,
			rCallback:function(r){
		...
		slide.dataEls.push({e:text6,a:h*3.5,b:h*4.6,
			rCallback:function(r){
		...
		slide.dataEls.push({e:text7,a:h*4.6,b:h*5.6,
			rCallback:function(r){
		...
		slide.dataEls.push({e:text8,a:h*4.6,b:h*5.8,
			rCallback:function(r){
		...
		slide.dataEls.push({e:man7,a:h*6,b:h*6.4,
			rCallback:function(r){
		...
		slide.dataEls.push({e:man9,a:h*6,b:h*6.4,
			rCallback:function(r){
		...
		slide.dataEls.push({e:text9,a:h*5.6,b:h*6.6,
			rCallback:function(r){
		...
		slide.dataEls.push({e:text10,a:h*6.2,b:h*7.2,
			rCallback:function(r){
		...
		slide.dataEls.push({e:man10,a:h*7.4,b:h*7.6,
			rCallback:function(r){
		...
		slide.dataEls.push({e:man11,a:h*7.6,b:h*8.7,
			rCallback:function(r){
		...
		slide.dataEls.push({e:text11,a:h*7.1,b:h*8.1,
			rCallback:function(r){
		...
		slide.dataEls.push({e:text12,a:h*7.1,b:h*8.2,
			rCallback:function(r){
		...
		slide.dataEls.push({e:text13,a:h*7.4,b:h*8.3,
			rCallback:function(r){
		...
		slide.dataEls.push({e:text14,a:h*7.7,b:h*8.7,
			rCallback:function(r){
		...
		slide.dataEls.push({e:man12,a:h*8.7,b:h*9,
			rCallback:function(r){
		...
		slide.dataEls.push({e:man13,a:h*8.8,b:h*9.3,
			rCallback:function(r){
		...
		slide.dataEls.push({e:text15,a:h*8.3,b:h*9.4,
			rCallback:function(r){
		...
		slide.dataEls.push({e:text16,a:h*8.2,b:h*9.3,
			rCallback:function(r){
		...
		slide.dataEls.push({e:text17,a:h*8.4,b:h*9.4,
			rCallback:function(r){
		...
		slide.dataEls.push({e:text18,a:h*8.8,b:h*9.9,
			rCallback:function(r){
		...
		slide.dataEls.push({e:man14,a:h*10.5,b:h*10.9,
			rCallback:function(r){
		...
		slide.dataEls.push({e:text19,a:h*10.3,b:h*11.3,
			rCallback:function(r){
		...
		slide.dataEls.push({e:text20,a:h*10.2,b:h*11.5,
			rCallback:function(r){
		...
		slide.dataEls.push({e:text21,a:h*10.3,b:h*11.6,
			rCallback:function(r){
		...
		slide.dataEls.push({e:text22,a:h*10.7,b:h*11.8,
			rCallback:function(r){
		...
		slide.dataEls.push({e:man15,a:h*11.5,b:h*11.6,
			rCallback:function(r){
		...
		slide.dataEls.push({e:man16,a:h*11.7,b:h*12,
			rCallback:function(r){
		...
		slide.dataEls.push({e:man17,a:h*12.1,b:h*12.3,
			rCallback:function(r){
		...
		slide.dataEls.push({e:text23,a:h*12.1,b:h*13.2,
			rCallback:function(r){
		...
		slide.dataEls.push({e:text24,a:h*12.3,b:h*13.4,
			rCallback:function(r){
		...
		slide.dataEls.push({e:end1,a:h*13.2,b:h*13.5,
			rCallback:function(r){	
		...
		slide.dataEls.push({e:end2,a:h*13.3,b:h*13.6,
			rCallback:function(r){	
		...
		slide.dataEls.push({e:end3,a:h*13.4,b:h*13.7,
			rCallback:function(r){	
		...
		slide.dataEls.push({e:end4,a:h*13.7,b:h*13.9,
			rCallback:function(r){	
		...
		slide.dataEls.push({e:end5,a:h*13.8,b:h*14,
			rCallback:function(r){	
		...
		slide.dataEls.push({e:app.clock,a:0,b:app.loadingBg.height,
			rCallback:function(r){
		...
		slide.dataEls.push({e:end5,a:h*14.5,b:h*14.6,
